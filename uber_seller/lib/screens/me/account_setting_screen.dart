...
class AccountSettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final seller = context.watch<AppCubit>().state.seller!;
...
class _NameSettingState extends State<NameSetting> {
  ...
  void initState() {
    ...
    final seller = context.read<AppCubit>().state.seller!;
    _controller = TextEditingController(text: seller.name);
  ...
  save() async {
    ...
    final name = _controller.text;
    await context.read<AppCubit>().updateSeller(seller.copyWith(name: name));
