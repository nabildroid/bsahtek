...
class AccountSettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final deliver = context.watch<AppCubit>().state.deliveryMan!;
...
class _NameSettingState extends State<NameSetting> {
  ...
  void initState() {
    ...
    final deliver = context.read<AppCubit>().state.deliveryMan!;
    _controller = TextEditingController(text: deliver.name);
  ...
  save() async {
    ...
    final name = _controller.text;
    await context.read<AppCubit>().updateClient(deliver.copyWith(name: name));
